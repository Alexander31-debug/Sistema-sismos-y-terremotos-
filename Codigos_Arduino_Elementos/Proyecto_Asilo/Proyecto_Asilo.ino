...
void setup() {
  ...
  myDFPlayer.volume(20);  // Ajustar el volumen (0 a 30)
...
void activarAlarma(int sonido) {
  ...
  // Encender la tira LED blanca durante 10 segundos
  digitalWrite(ledBlancaPin, LOW);
  delay(200);  // Espera 10 segundos

  // Apagar la tira LED blanca
  digitalWrite(ledBlancaPin, HIGH);
...
void enviarSMS(const char* mensaje) {
  ...
  mySIM800.println("AT+CMGS=\"+50256997632\"");  // Segundo numero de destino
  delay(1000);
  mySIM800.print(mensaje);
  delay(100);
  mySIM800.write(26);  // Enviar CTRL+Z para enviar el mensaje
